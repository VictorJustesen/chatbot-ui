...
{console.log(tutorialData[currentPage].imageSrc)}
         ...
         <div className='Info'>
           <div className='top'>
            ...
            <div className='buttons'>
                <button className='button' onClick={handlePrevious} disabled={currentPage === 0}>
                    Previous
                </button>
                <button  className='button' onClick={handleNext} disabled={currentPage === tutorialData.length - 1}>
                    Next
                </button>
            </div>
        </div>
